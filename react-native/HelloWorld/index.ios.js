          ...
          <View style={[styles.height160, styles.part_1_right,]}>
            ...
            <View style={[{flex:1, flexDirection: 'row',borderTopWidth:0.5, borderColor:'#DDD8CE'}]}>
              <View style={{flex:1, borderRightWidth:1, borderColor:'#DDD8CE',}}>
                  <Text style={{color:'#F742AB', marginLeft:5,fontWeight:'bold', fontSize:15, marginTop:18}}>聚餐宴请</Text>
              ...
              <View style={{flex:1,}}>
                  <Text style={[styles.font14,{color:'#FF8601', marginTop:18, marginLeft:5}]}>名店抢购</Text>
